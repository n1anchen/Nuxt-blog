	...
	app: {
		head: {
			...
			link: [
				...
				{ rel: 'stylesheet', href: 'https://fonts.proxy.ustclug.org/css2?family=JetBrains+Mono:ital,wght@0,100..800;1,100..800&family=Noto+Serif+SC:wght@100..900&family=Noto+Serif+SC:wght@200..900&display=swap', media: 'print', onload: 'this.media="all"' },
				// 小米字体 "MiSans"
				...
				// 霞鹜文楷
				{ rel: 'stylesheet', href: 'https://cdnjs.webstatic.cn/ajax/libs/lxgw-wenkai-screen-webfont/1.7.0/style.min.css', media: 'print', onload: 'this.media="all"' },
			],
			templateParams: {
				separator: '|',
			},
